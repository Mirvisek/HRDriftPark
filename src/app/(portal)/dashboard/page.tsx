      ...
      customAction: isShiftActive ? (
        <div className="flex items-center gap-2 mt-1">
          <button
            ...
            className="px-2.5 py-1 rounded bg-black/40 hover:bg-black/60 text-white text-[10px] font-black uppercase tracking-wider flex items-center gap-1 border border-white/20 transition"
          >
        ...
        <button
          ...
          className="mt-1 px-2.5 py-1 rounded bg-brand-gold/20 hover:bg-brand-gold/30 text-brand-gold text-[10px] font-black uppercase tracking-wider flex items-center gap-1 border border-brand-gold/30 transition"
        >
